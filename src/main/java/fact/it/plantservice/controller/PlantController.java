...
public class PlantController {
    ...
    public void fillDB() {
        ...
        if (plantRepository.count() == 0) {
            ...
            plantRepository.save(new Plant(3, "P0103", "Klimop", "Ondanks dat sommigen hem liever kwijt zijn dan rijk, is de klimop in Nederland een erg populaire plant. Waarschijnlijk heeft de plant deze status te danken aan het feit dat het een makkelijke plant is die het overal goed doet. Ook blijft de Hedera het hele jaar door groen en is het een geschikte plant om het gevoel van een verticale tuin mee te creëren."));
            plantRepository.save(new Plant(3, "P0104", "Hartlelie", "Door zijn vele soorten is er wat de hartlelie betreft voor iedereen wel een passende variant te vinden. De Hosta is bijvoorbeeld te krijgen met goudgele, witte, roomwit omrande, groene of blauwe (zweem) bladeren."));

            plantRepository.save(new Plant(1, "P0105", "Lavendel", "De lavendel is vooral populair door de mooie diep paarse kleur én de heerlijke geur die deze plant verspreidt. Lavendel is een kleine vaste tuinplant voor in de tuin. De plant wordt namelijk niet hoger dan één meter en doet klein aan door de dunne stengels waar de plant uit bestaat."));
            plantRepository.save(new Plant(2, "P0106", "Viooltje", "Niet iedere populaire plant is een grote plant. Het kleine viooltje blijft een favoriet voor in de Nederlandse tuin. Dit omdat wij toch wel fan zijn van dit kleine, fleurige plantje. Door de vele kleuruitvoeringen past er in iedere tuin wel een viooltje en daarom kon hij niet ontbreken in deze lijst van de meest populaire tuinplanten van Nederland."));
            plantRepository.save(new Plant(2, "P0107", "Geranium", "Pelargonium (pelargos) betekent ooievaarsbek en het is dan ook om die reden dat de geranium ook wel ooievaarsbek genoemd wordt. Geraniums hebben lange tijd een wat stoffig imago gehad door het bekende gezegde ‘achter de geraniums zitten'. De plant wordt veelal geassocieerd met oude mensen die de hele dag maar binnen zitten."));
            plantRepository.save(new Plant(2, "P0108", "Spaanse margriet", "De Spaanse margriet is niet, zoals je zou verwachten, afkomstig uit Spanje. Deze populaire plant komt uit het verre Zuid-Afrika en is een éénjarige tuinplant."));
            plantRepository.save(new Plant(3, "P0109", "Vlinderstruik", "Dat de vlinderstruik bij de meest populaire tuinplanten van Nederland zit verbaasd ons wederom niets. Deze plant is niet alleen mooi om te zien, maar trekt ook nog eens de mooiste vlinders aan. Zo zullen onder andere het koolwitje, de citroenvlinder en de atalanta de verleiding van deze plant niet kunnen weerstaan."));
        }
